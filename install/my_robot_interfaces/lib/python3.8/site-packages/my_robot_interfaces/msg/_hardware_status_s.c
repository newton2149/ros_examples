...
bool my_robot_interfaces__msg__hardware_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tempreature
    PyObject * field = PyObject_GetAttrString(_pymsg, "tempreature");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tempreature = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // are_motors_ready
...
PyObject * my_robot_interfaces__msg__hardware_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // tempreature
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->tempreature);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tempreature", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
