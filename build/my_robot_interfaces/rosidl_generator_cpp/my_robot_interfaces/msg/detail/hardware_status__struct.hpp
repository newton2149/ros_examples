...
struct HardwareStatus_
{
  ...
  using _tempreature_type =
    int64_t;
  _tempreature_type tempreature;
  ...
  Type & set__tempreature(
    const int64_t & _arg)
  {
    this->tempreature = _arg;
    return *this;
  }
  ...
  {
    if (this->tempreature != other.tempreature) {
      return false;
    }
