...
class Init_HardwareStatus_tempreature
{
public:
  Init_HardwareStatus_tempreature()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_HardwareStatus_are_motors_ready tempreature(::my_robot_interfaces::msg::HardwareStatus::_tempreature_type arg)
  {
    msg_.tempreature = std::move(arg);
...
{
  return my_robot_interfaces::msg::builder::Init_HardwareStatus_tempreature();
}
