...
class Init_LedStatus_states
{
public:
  Init_LedStatus_states()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::my_robot_interfaces::msg::LedStatus states(::my_robot_interfaces::msg::LedStatus::_states_type arg)
  {
...
{
  return my_robot_interfaces::msg::builder::Init_LedStatus_states();
}
