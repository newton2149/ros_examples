...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.tempreature = kwargs.get('tempreature', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.tempreature != other.tempreature:
            return False
    ...
    def tempreature(self):
        """Message field 'tempreature'."""
        return self._tempreature

    @tempreature.setter
    def tempreature(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'tempreature' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'tempreature' field must be an integer in [-9223372036854775808, 9223372036854775807]"
